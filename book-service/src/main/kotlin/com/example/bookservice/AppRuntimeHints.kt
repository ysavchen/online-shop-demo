...
/**
 * GraalVM анализирует достижимость классов, полей, методов, чтобы потом удалить все лишнее.
 *
 * Хинты подсказывают, какие классы, методы и ресурсы понадобятся в Runtime,
