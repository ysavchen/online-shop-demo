package com.mycompany.online_shop_backend.controller.handler;
...
public class ControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> unauthorizedException(UsernameNotFoundException ex, HttpServletRequest request) {
        var errorResponse = new ErrorResponse(HttpStatus.UNAUTHORIZED, ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> exception(Exception ex, HttpServletRequest request) {
        ...
        var errorResponse = new ErrorResponse(httpStatus, ex.getMessage(), request.getRequestURI());
